        ...
        <form name="form" method="post" action="update_student_profile.php" class="form-horizontal container ">
          ...
          <div class="form-group row justify-content-center"> <!-- student username !-->
            <div class="col-sm-4 ">
              ...
              <input type="text" name="student_username" required="required" class="form-control" placeholder="Username">
           </div>  
          ...
          <div class="form-group row justify-content-center">
            ...
            <div class="col-sm-4 ">
              ...
              <input type="email" name="student_email" required="required" class="form-control" placeholder="Email Address" >
            </div>
          </div>
             <div class="form-group row justify-content-center">
