...
<html lang="en" dir="ltr">
  <head>
    ...
    <div class="" style="height:900px; background-color:#F2E4B9; padding-top:2%;">
      <center>
        <form name="form" method="post" action="update_student_profile.php" class="form-horizontal container ">
          ...
          <div class="form-group row justify-content-center"> <!-- student username !-->
            <div class="col-sm-4 ">
              ...
              <input type="text" name="student_username" value="<?php echo $student_username; ?>" required="required" class="form-control" placeholder="Username">
           </div>  
          ...
          <div class="form-group row justify-content-center">
            <div class="col-sm-4 ">
              ...
              <input type="text" name="last_name" required="required" class="form-control" placeholder="Last Name" value="<?php echo $last_username; ?>">
            </div>
          </div>
          <div class="form-group row justify-content-center">
             <div class="col-sm-4 ">
              <label for="" style="float:left;">First Name:</label>
              <input type="text" name="first_name" required="required"  class="form-control" placeholder="First Name" value="<?php echo $first_name; ?>">
            </div>
          </div>
            <div class="form-group row justify-content-center">
            <div class="col-sm-4 ">
              <label for="" style="float:left;">Email Address:</label>
              <input type="email" name="student_email" required="required" class="form-control" placeholder="Email Address" value="<?php echo $student_email; ?>">
            </div>
          </div>
             <div class="form-group row justify-content-center">
