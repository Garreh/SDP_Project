<?php
    ...
    if(isset($_POST['group_id']) && isset($_POST['delete']))
    {
        ...
        {
            $q1 = "SELECT * FROM post INNER JOIN private_group ON post.group_id = private_group.group_id WHERE post.group_id = '$group_id'";
            $output1 = mysqli_query($conn,$q1);
            ...
            $sql18 = "SELECT * FROM student_group WHERE group_id = '$group_id'";
            $result18 = mysqli_query($conn,$sql18);
                    
            if(mysqli_num_rows($result18)>0)
            {
                $sql19 = "DELETE FROM student_group WHERE group_id = '$group_id'";
                mysqli_query($conn,$sql19);
            }
            
            $q2 = "DELETE FROM private_group WHERE group_id = '$group_id'";
