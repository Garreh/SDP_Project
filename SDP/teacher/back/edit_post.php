<?php
    ...
    if(isset($_POST['post_id']) && isset($_POST['post_title']) && isset($_POST['post_description']))
    {     
        $post_id = $_POST['post_id'];
        $post_title = $_POST['post_title'];
        $post_description = $_POST['post_description'];
        
        $sql = "UPDATE post SET post_title = '$post_title', post_description = '$post_description' WHERE post_id = '$post_id' AND group_id IS NULL";
