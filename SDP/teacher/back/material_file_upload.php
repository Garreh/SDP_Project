...
{
	$filename = basename($_FILES['material_image']['name']); //result = abc.jpg
	
	//second: get the filesize
	$checkfilesize = $_FILES['material_image']['size'];
	...
	if(!move_uploaded_file($_FILES['material_image']['tmp_name'],$destination))
	{
