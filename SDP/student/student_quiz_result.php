        ...
        <div class="card">
            <div class="card-body">
                ...
                <?php
                    ...
                    $sql2 = "SELECT COUNT(*) AS nocq FROM quiz inner join question on quiz.quiz_id = question.quiz_id inner join answer on question.question_id = answer.question_id inner join student_answer on student_answer.answer_id = answer.answer_id WHERE answer.answer_correct = 1 and quiz.quiz_id = '$quiz_id' ";
