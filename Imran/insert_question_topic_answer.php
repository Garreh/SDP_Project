...
$answer_description_correct= mysqli_real_escape_string($db, $_POST['answer_description_correct']);
...
$quiz_title = mysqli_real_escape_string($db, $_POST['quiz_title']);
$quiz_description = mysqli_real_escape_string($db, $_POST['quiz_description']);
